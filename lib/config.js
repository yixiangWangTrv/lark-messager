...
export function loadConfig(configPath) {
  ...
  config.lark.trigger_modes = {
    ...
    all_messages: false,
    allow_private: false,
    mention_owner_reply_identity: "bot",
    mention_owner_group_filter: { mode: "none", group_ids: [] },
    ...config.lark.trigger_modes,
  };
  config.lark.trigger_modes.mention_owner_group_filter = {
    mode: "none",
    group_ids: [],
    ...config.lark.trigger_modes.mention_owner_group_filter,
  };
  config.prompt = {
    ...defaultPromptConfig,
    ...config.prompt,
    operational_safety: { ...defaultPromptConfig.operational_safety, ...config.prompt?.operational_safety },
  ...
  config.recording = {
    ...
    modes: {
      ...
      all_messages: true,
      allow_private: true,
      legacy_group_names: true,
    },
    lark_base: { url: "", app_token: "", table_id: "", table_name: "Oncall Bot Records" },
    ...config.recording,
  };
  config.recording.modes = {
    mention_bot: true,
    mention_owner: true,
    all_messages: true,
    allow_private: true,
  ...
  config.recording.lark_base = {
    url: "",
    app_token: "",
    table_id: "",
    table_name: "Oncall Bot Records",
    ...config.recording.lark_base,
  };
